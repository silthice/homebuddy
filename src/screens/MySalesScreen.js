...
class MySalesScreen extends React.Component {
    ...
    getMySale = async () => {
        ...
        let result = await new HTTP().post(CONSTS.clone_URL + 'mySalesJs', {mlm_id, session_no});

        if (result.status){
            this.setState({ }) //mySales: result.list
        }
        //console.log('APIDATA : ', APIData);
        console.log('My Sales Src getMySale: ', result.errors);
    }
                ...
                <StatusBar translucent backgroundColor="transparent" barStyle="dark-content" />
                    <Left style={{flex: 1}}>
                        <Button transparent onPress={() => navigation.goBack()}>
                            ...
                            <Text style={{fontWeight: 'bold', fontSize: 20, marginLeft: 10}}>My Sales</Text>
                        </Button>
                    </Left>
                    <Body style={{flex: 0}}>
                    </Body>
                ...
                <Content>
                    ...
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <View style={{alignItems: 'center', justifyContent: 'center', marginRight: 10}}>
                            <Image style={{ height: 80, width: 80 }} source={require('../../img/sale_pending.png')} />
                            <Text style={{fontSize: 10}}>Pending Sales</Text>
                        </View>
                        </TouchableOpacity>

                        <TouchableOpacity>
                        <View style={{alignItems: 'center', justifyContent: 'center'}}>
                            <Image style={{ height: 80, width: 80 }} source={require('../../img/sale_completed.png')} />
                            <Text style={{fontSize: 10}}>Completed Sales</Text>
                        </View>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View>
                        <View style={{flexDirection: 'row', alignItems: 'center', padding: 8}}>
                            <Image style={{ height: 50, width: 50, borderRadius: 10, marginRight: 10 }} source={require('../../img/product1.png')} />
                            <View style={{flexDirection: 'row', width: screenWidth * 0.6}}>
                                <Text>
                                    <Text style={{fontSize: 12, fontWeight: 'bold'}}>jamie</Text>
                                    <Text style={{fontSize: 12}}> sends a deal request to your item: </Text>
                                    <Text style={{fontSize: 12, fontWeight: 'bold'}}> iPhone 11 Pro Black 256GB Full Set under Warranty</Text>
                                </Text>

                            </View>
                            <View style={{marginTop: -25}}>
                                <Text style={{fontSize: 8}}>01/01/2021 00:00:00</Text>
                            </View>
                        </View>
                    </View>
